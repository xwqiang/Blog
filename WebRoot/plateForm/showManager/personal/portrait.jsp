...
<body>
	<div class='main_content'>
			<div id="image_area">
			<span>预览</span>
				<img id="biuuu"  alt="" title="请选择你的头像">
			</div>

			<div id ="upload_area">
				<form id ="form1" name = "form" action ='/SSO_new/showManager/personalAction!loadPortrait.dhtml?tt=2' enctype = 'multipart/form-data'  method = 'post' onsubmit="return _check();">
					...
					<input type= "submit" value = "提交 " onclick="javascript:_submit()"/>
				</form>
			</div>
	</div>
</body>
